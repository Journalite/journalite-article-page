 ...
 */ const Editor = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].forwardRef(({ articleId, initialContent = '', onChange, placeholder = 'Tell your story...', className = '' }, ref)=>{
    ...
    // Method to insert HTML content at cursor position
    const insertHTMLAtCursor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((html)=>{
        if (!viewRef.current) return;
        try {
            const { state, dispatch } = viewRef.current;
            // Parse the HTML into a ProseMirror document fragment
            const fragment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$editor$2f$schema$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseHTML"])(html);
            // Create transaction to insert the HTML content
            ...
            // Don't fall back to inserting HTML as text - it shows raw HTML
            console.warn('HTML insertion failed, skipping to avoid raw HTML text');
        }
    }, [
        insertTextAtCursor
    ]);
    // Method to insert image as proper ProseMirror node
    const insertImageAtCursor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((src, alt = '')=>{
        if (!viewRef.current) return;
        console.log('insertImageAtCursor called with:', {
            src,
            alt,
        ...
        try {
            ...
            if (!src || !src.startsWith('http')) {
                console.error('Invalid image src provided:', src);
                return;
            }
            // Create image node with proper attributes
            ...
            console.log('Created image node:', imageNode.attrs);
            ...
            // Focus the editor
            viewRef.current.focus();
            console.log('Image inserted successfully:', src);
        } catch (error) {
            console.error('Failed to insert image:', error, {
                src,
                alt
            });
        // Don't fall back to HTML insertion as it shows raw HTML text
        }
    }, []);
    ...
    const insertImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        ...
        input.onchange = async (e)=>{
            ...
            try {
                ...
                const { uploadImageViaAPI } = await __turbopack_context__.r("[project]/src/lib/cloudinary.ts [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
                // Upload to Cloudinary
                const imageUrl = await uploadImageViaAPI(file);
...
"[project]/src/lib/cloudinary.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
// Client-side upload function (no server-side imports)
__turbopack_context__.s({
    "uploadImage": (()=>uploadImage),
    "uploadImageViaAPI": (()=>uploadImageViaAPI)
});
const uploadImage = async (file)=>{
    const formData = new FormData();
    formData.append('file', file);
    formData.append('upload_preset', ("TURBOPACK compile-time value", "journalite_unsigned") || '');
    try {
        const response = await fetch(`https://api.cloudinary.com/v1_1/${("TURBOPACK compile-time value", "dwqint9xm")}/image/upload`, {
            method: 'POST',
            body: formData
        });
        if (!response.ok) {
...
"[project]/src/components/MediaUploadPlugin.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>MediaUploadPlugin)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/cloudinary.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
function MediaUploadPlugin({ onImageInsert, onVideoInsert, editorRef, className = '' }) {
    ...
    const handleFileUpload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (file)=>{
        ...
        if (file.size > maxSize) {
            alert(`File too large. Maximum size: ${isImage ? '10MB' : '100MB'}`);
            return;
        }
        setIsUploading(true);
        setUploadProgress(0);
        try {
            ...
            const imageUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadImageViaAPI"])(file);
            clearInterval(progressInterval);
            setUploadProgress(100);
            // Insert into editor
            if (isImage) {
                onImageInsert(imageUrl, file.name);
            } else if (isVideo && onVideoInsert) {
                onVideoInsert(imageUrl);
            }
    ...
    const handlePaste = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((e)=>{
        ...
        console.log('MediaUploadPlugin paste detected:', {
            items: items ? Array.from(items).map((i)=>i.type) : [],
            htmlContent,
            textContent
        });
        // Block ALL HTML content that contains images - prevent raw HTML from appearing
        if (htmlContent && htmlContent.includes('<img') || textContent && textContent.includes('<img') || textContent && textContent.includes('<p><img') || textContent && textContent.match(/<p><img[^>]*><\/p>/) || textContent && textContent.match(/^<p><img.*<\/p>$/) || htmlContent && htmlContent.match(/<img[^>]*>/)) {
            console.log('MediaUploadPlugin: Blocking HTML image paste completely');
            console.log('Blocked content:', {
                htmlContent: htmlContent?.substring(0, 100),
                textContent: textContent?.substring(0, 100)
            });
            // Completely block any HTML image content
            e.preventDefault();
            e.stopPropagation();
            e.stopImmediatePropagation();
            return;
        }
        // Handle actual image files from clipboard
        if (items) {
            for (const item of Array.from(items)){
                if (item.type.startsWith('image/')) {
                    console.log('MediaUploadPlugin: Handling image file paste');
                    e.preventDefault();
                    e.stopPropagation();
                    e.stopImmediatePropagation();
    ...
    // Setup paste listener when component mounts
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                ...
                fileName: "[project]/src/components/MediaUploadPlugin.tsx",
                lineNumber: 177,
                columnNumber: 7
            }, this),
            dragActive && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                style: {
                    position: 'fixed',
                    top: 0,
                    left: 0,
                ...
                onDrop: handleDrop,
                children: "Drop your image or video here"
            }, void 0, false, {
                fileName: "[project]/src/components/MediaUploadPlugin.tsx",
                lineNumber: 187,
                columnNumber: 9
...
"[project]/src/components/MediumStyleEditor.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MediaUploadPlugin$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/MediaUploadPlugin.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
;
;
const MediumStyleEditor = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["forwardRef"])(({ articleId, initialContent = '', onChange, placeholder = 'Tell your story...', className = '', onImageInsert, onVideoInsert }, ref)=>{
    const editorRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    // Insert image at cursor position
    const insertImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((imageUrl, alt = '')=>{
        if (!editorRef.current) return;
        // Call parent handler if provided
        if (onImageInsert) {
            onImageInsert(imageUrl, alt);
        }
        // ALWAYS use the proper insertImage method to avoid showing raw HTML
        if (editorRef.current.insertImage) {
            editorRef.current.insertImage(imageUrl, alt);
        } else {
            console.error('insertImage method not available on editor ref');
        }
    }, [
        onImageInsert
    ]);
    // Insert video at cursor position 
    const insertVideo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((videoUrl)=>{
        if (!editorRef.current) return;
        // Call parent handler if provided
        if (onVideoInsert) {
            onVideoInsert(videoUrl);
        }
        // For videos, we'll use a simple link format for now
        // You can enhance this later with a proper video node in the schema
        const videoMarkdown = `[📹 Video](${videoUrl})`;
        editorRef.current.insertText(videoMarkdown);
    }, [
        onVideoInsert
    ]);
    // Insert text at cursor position
    const insertText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((text)=>{
        if (!editorRef.current) return;
        editorRef.current.insertText(text);
    }, []);
    // Focus the editor
    const focus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (!editorRef.current) return;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        className: "jsx-4b23bb7b0446bdb3" + " " + `medium-style-editor ${className}`,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MediaUploadPlugin$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                onImageInsert: insertImage,
                onVideoInsert: insertVideo,
                editorRef: editorRef
            }, void 0, false, {
                fileName: "[project]/src/components/MediumStyleEditor.tsx",
                lineNumber: 92,
                columnNumber: 7
            }, this),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                id: "4b23bb7b0446bdb3",
                children: ".medium-style-editor.jsx-4b23bb7b0446bdb3{width:100%;position:relative}.medium-editor-content.jsx-4b23bb7b0446bdb3{color:#292929;border:none;outline:none;min-height:200px;font-family:Charter,Times New Roman,serif;font-size:21px;line-height:1.58}.medium-editor-content img{border-radius:8px;max-width:100%;height:auto;margin:2rem 0;box-shadow:0 4px 12px #0000001a}.medium-editor-content p{margin:1.6rem 0}.medium-editor-content h1{margin:2rem 0 1rem;font-size:2.25rem;font-weight:700;line-height:1.2}.medium-editor-content h2{margin:1.75rem 0 .75rem;font-size:1.875rem;font-weight:600;line-height:1.3}.medium-editor-content h3{margin:1.5rem 0 .5rem;font-size:1.5rem;font-weight:600;line-height:1.4}.medium-editor-content blockquote{color:#292929cc;border-left:3px solid #57e389;margin:2rem 0;padding-left:1.5rem;font-size:1.125rem;font-style:italic}.medium-editor-content pre{background:#f6f8fa;border-radius:8px;margin:2rem 0;padding:1.5rem;font-family:SFMono-Regular,Consolas,Liberation Mono,Menlo,monospace;font-size:.875rem;line-height:1.6;overflow-x:auto}.medium-editor-content ul{margin:1.5rem 0;padding-left:2rem}.medium-editor-content li{margin:.5rem 0}.medium-editor-content [href*=video]a{color:#fff;background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);border-radius:8px;margin:1rem 0;padding:.75rem 1.5rem;text-decoration:none;transition:transform .2s;display:inline-block}.medium-editor-content :hover[href*=video]a{transform:translateY(-2px)}.drag-active.medium-editor-content{background:#3b82f60d;border:2px dashed #3b82f6;border-radius:8px}"
...
const __TURBOPACK__default__export__ = MediumStyleEditor;
}}),
...
;
;
function ImageUpload({ onImageUpload, disabled = false, className = '', acceptedFormats = [
    'image/jpeg',
    'image/png',
    'image/gif',
    'image/webp'
], maxFileSize = 10, useServerUpload = false }) {
    const [isUploading, setIsUploading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [uploadProgress, setUploadProgress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const handleFileSelect = async (event)=>{
        ...
        try {
            ...
            const imageUrl = useServerUpload ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadImageViaAPI"])(file) : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadImage"])(file);
            clearInterval(progressInterval);
            setUploadProgress(100);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        `,
                children: isUploading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                acceptedFormats.map((format)=>format.split('/')[1]).join(', ').toUpperCase(),
                                " up to ",
                                maxFileSize,
                                "MB"
                            ]
            ...
            error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-2 text-sm text-red-600 bg-red-50 border border-red-200 rounded p-2",
                children: error
            }, void 0, false, {
                fileName: "[project]/src/components/ImageUpload.tsx",
                lineNumber: 177,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$clientApp$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/clientApp.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MediumStyleEditor$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/MediumStyleEditor.tsx [app-ssr] (ecmascript)");
...
const ArticleComposer = ({ articleId, onUpdateComplete, backToArticleAction, editingTitle })=>{
    ...
    // Handle image insertion into editor content
    const handleImageInsertion = (imageUrl, alt = '')=>{
        if (editorRef.current) {
            // Insert image as HTML that the editor can understand
            const imageHtml = `<p><img src="${imageUrl}" alt="${alt}" /></p>`;
            editorRef.current.insertText(imageHtml);
        }
    };
    // Handle video insertion into editor content
    const handleVideoInsertion = (videoUrl)=>{
        if (editorRef.current) {
            // For videos, create a simple link format
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                ...
                                                className: "flex-1 bg-white/80 backdrop-blur border border-stone-200 outline-none text-stone-600 placeholder-stone-400 py-2 px-4 rounded-lg focus:border-stone-400 transition-colors"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/ArticleComposer.tsx",
                                                lineNumber: 464,
                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                className: "px-4 py-2 bg-red-100/80 backdrop-blur border border-red-200 text-red-700 rounded-lg hover:bg-red-200/80 transition-colors",
                                                children: "Remove"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/ArticleComposer.tsx",
                                                lineNumber: 471,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MediumStyleEditor$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                            ref: editorRef,
                            ...
                            className: "seamless-editor medium-style-content",
                            onImageInsert: handleImageInsertion,
                            onVideoInsert: handleVideoInsertion
                        }, void 0, false, {
                            fileName: "[project]/src/components/ArticleComposer.tsx",
                            lineNumber: 525,
                            columnNumber: 11
...
//# sourceMappingURL=%5Broot-of-the-server%5D__403d723f._.js.map
    ...
    const handleGoogleSignIn = async ()=>{
        ...
        try {
            ...
            if (result.user) {
                ...
                const profileByUid = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$userService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserProfile"])(result.user.uid);
                ...
                if (!existingProfile && result.user.email) {
                    const profileByEmail = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$userService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserProfileByEmail"])(result.user.email);
                    if (profileByEmail) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0e06a6ec._.js.map
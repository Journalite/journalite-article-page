...
const CommentSection = ({ slug })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (!slug) return;
        setLoading(true);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getArticleComments"])(slug).then((data)=>{
    ...
    const handleCommentSubmit = async (e)=>{
        ...
        try {
            setSubmitting(true);
            const comment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["postComment"])(slug, currentUser.id, newComment);
            setComments((prev)=>[
                    comment,
                    ...prev
                ]);
    ...
    const handleReplySubmit = async (commentId)=>{
        ...
        try {
            ...
            const reply = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["postReply"])(slug, commentId, currentUser.id, replyContent);
            // Update the local state with the new reply
            setComments((prev)=>prev.map((comment)=>comment.commentId === commentId ? {
                        ...comment,
                        replies: [
                            ...comment.replies || [],
                            reply
    ...
    const handleLikeComment = async (commentId)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["likeComment"])(slug, commentId, currentUser.id);
            // Update local state
            setComments((prev)=>prev.map((comment)=>comment.commentId === commentId ? {
                        ...comment,
                        likes: result.likes
    ...
    const handleLikeReply = async (commentId, replyId)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["likeReply"])(slug, commentId, replyId, currentUser.id);
            // Update local state
            setComments((prev)=>prev.map((comment)=>comment.commentId === commentId ? {
                        ...comment,
                        replies: comment.replies.map((reply)=>reply.replyId === replyId ? {
                                ...reply,
                                likes: result.likes
                            } : reply)
                    } : comment));
    ...
    const handleDeleteComment = async (commentId)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteComment"])(slug, commentId, currentUser.id);
    ...
    const handleDeleteReply = async (commentId, replyId)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteReply"])(slug, commentId, replyId, currentUser.id);
    ...
    const getUserAvatar = (userId, isReply = false)=>{
                    ...
                    children: isAuthenticated ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: getUserAvatar(currentUser.id)
                            }, void 0, false, {
                                fileName: "[project]/src/components/CommentSection.tsx",
                                lineNumber: 305,
                                columnNumber: 15
            ...
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: comments.map((comment)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            comment.replies && comment.replies.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: `replies-toggle-icon ${expandedReplies[comment.commentId] ? 'open' : ''}`,
                                                children: "▷"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/CommentSection.tsx",
                                                lineNumber: 435,
                                    ...
                                    expandedReplies[comment.commentId] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            reply.userId === currentUser.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            replyingTo === comment.commentId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: `reply-form ${comment.replies && comment.replies.length > 0 ? 'in-thread' : ''}`,
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("textarea", {
...
const RenderArticle = ({ article })=>{
    ...
    const isComplex = (a)=>Array.isArray(a.content);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07504c4c._.js.map
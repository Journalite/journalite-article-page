...
"[project]/src/utils/backgroundTheme.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
// Background color options - creamy colors
__turbopack_context__.s({
    "BACKGROUND_COLORS": (()=>BACKGROUND_COLORS),
    "applyBackgroundTheme": (()=>applyBackgroundTheme),
    "getBackgroundColorById": (()=>getBackgroundColorById),
    "getCurrentBackgroundTheme": (()=>getCurrentBackgroundTheme),
    "loadSavedBackgroundTheme": (()=>loadSavedBackgroundTheme),
    "useBackgroundTheme": (()=>useBackgroundTheme)
});
const BACKGROUND_COLORS = [
    {
        id: 'default',
        name: 'Classic Cream',
        gradient: 'linear-gradient(135deg, #f0f9ff 0%, #f7fafc 20%, #fef7ff 40%, #f0fdfa 60%, #fff7ed 80%, #f3f4f6 100%)',
        preview: '#f8fafc'
    },
    {
        id: 'warm-cream',
        name: 'Warm Cream',
        gradient: 'linear-gradient(135deg, #fefcbf 0%, #fef3c7 25%, #fde68a 50%, #fcd34d 75%, #f59e0b 100%)',
        preview: '#fef3c7'
    },
    {
        id: 'soft-peach',
        name: 'Soft Peach',
        gradient: 'linear-gradient(135deg, #fef2f2 0%, #fde8e8 25%, #fecaca 50%, #fca5a5 75%, #f87171 100%)',
        preview: '#fde8e8'
    },
    {
        id: 'lavender-cream',
        name: 'Lavender Cream',
        gradient: 'linear-gradient(135deg, #faf5ff 0%, #f3e8ff 25%, #e9d5ff 50%, #d8b4fe 75%, #c084fc 100%)',
        preview: '#f3e8ff'
    },
    {
        id: 'mint-cream',
        name: 'Mint Cream',
        gradient: 'linear-gradient(135deg, #f0fdf4 0%, #dcfce7 25%, #bbf7d0 50%, #86efac 75%, #4ade80 100%)',
        preview: '#dcfce7'
    },
    {
        id: 'pearl-white',
    ...
    },
    {
        id: 'rose-cream',
        name: 'Rose Cream',
        gradient: 'linear-gradient(135deg, #fff1f2 0%, #ffe4e6 25%, #fecdd3 50%, #fda4af 75%, #fb7185 100%)',
        preview: '#ffe4e6'
    },
    {
        id: 'golden-cream',
        name: 'Golden Cream',
        gradient: 'linear-gradient(135deg, #fffbeb 0%, #fef3c7 25%, #fde68a 50%, #facc15 75%, #eab308 100%)',
        preview: '#fef3c7'
    }
];
const getCurrentBackgroundTheme = ()=>{
    if ("TURBOPACK compile-time truthy", 1) return 'default';
    "TURBOPACK unreachable";
};
const getBackgroundColorById = (id)=>{
    return BACKGROUND_COLORS.find((color)=>color.id === id) || BACKGROUND_COLORS[0];
};
...
const loadSavedBackgroundTheme = ()=>{
    const savedTheme = getCurrentBackgroundTheme();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$backgroundTheme$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/backgroundTheme.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function HomePage() {
    ...
    // Load saved background theme on component mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$backgroundTheme$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loadSavedBackgroundTheme"])();
    }, []);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d1266579._.js.map
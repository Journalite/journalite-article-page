...
// Log Firebase config for debugging (don't include this in production)
...
try {
    ...
    // Test if we can access the internal Firestore object
    // @ts-ignore - Accessing internal property for debugging
    if (db._delegate) {
        console.log('Firestore internal object available');
    }
} catch (error) {
    ...
    // Provide a placeholder to prevent app crashes
    throw new Error(`Failed to initialize Firestore: ${error.message}`);
}
// Connect to Auth and Firestore Emulator in development mode
if ("object" !== 'undefined' && ("TURBOPACK compile-time value", "development") === 'development' && window.location.hostname === 'localhost') {
    try {
        // connectAuthEmulator(auth, "http://localhost:9099", { disableWarnings: true });
        // connectFirestoreEmulator(db, 'localhost', 8080);
        console.log('Using Firebase in production mode');
    } catch (error) {
...
;
function Typewriter({ phrases, loop = true, typingSpeed = 150, deletingSpeed = 100, delayBetween = 2000 }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Typewriter.useEffect": ()=>{
            ...
            if (!isDeleting && charIndex < currentPhrase.length) {
                ...
                }["Typewriter.useEffect"], typingSpeed);
                ...
                }["Typewriter.useEffect"], deletingSpeed);
            } else if (!isDeleting && charIndex === currentPhrase.length) {
                timer = setTimeout({
                    "Typewriter.useEffect": ()=>setIsDeleting(true)
                }["Typewriter.useEffect"], delayBetween);
            } else if (isDeleting && charIndex === 0) {
                setIsDeleting(false);
                setPhraseIndex({
...
_s(Typewriter, "KfzTMbbUonisrcEWmmLdSRp6gSE=");
_c = Typewriter;
var _c;
...
function HomePage() {
    ...
    const [isAuthenticated, setIsAuthenticated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Initialize as false
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": ()=>{
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (articlesData) {
                                ...
                                const nonFeaturedArticles = featuredArticle ? articlesData.filter({
                                    "HomePage.useEffect.fetchArticles": (article)=>article.slug !== featuredArticle.slug
                                }["HomePage.useEffect.fetchArticles"]) : articlesData;
                                setArticles(nonFeaturedArticles);
                                // Extract all unique tags
                                const allTags = articlesData.flatMap({
                                    "HomePage.useEffect.fetchArticles.allTags": (article)=>article.tags || []
                                }["HomePage.useEffect.fetchArticles.allTags"]).filter({
                                    "HomePage.useEffect.fetchArticles.allTags": (tag, index, self)=>self.indexOf(tag) === index
                                }["HomePage.useEffect.fetchArticles.allTags"]);
                                setTags(allTags);
                            }
                        } catch (apiError) {
                            ...
                            const allTags = mockArticles.flatMap({
                                "HomePage.useEffect.fetchArticles.allTags": (article)=>article.tags || []
                            }["HomePage.useEffect.fetchArticles.allTags"]).filter({
                                "HomePage.useEffect.fetchArticles.allTags": (tag, index, self)=>self.indexOf(tag) === index
                            }["HomePage.useEffect.fetchArticles.allTags"]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$styles$2f$home$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"]['three-column-layout']} ${isSidebarCollapsed ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$styles$2f$home$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"]['collapsedLayout'] : ''}`,
        children: [
...
_s(HomePage, "4HbjMcRlxMy4ZbdGlPrhibYCyI0=");
_c = HomePage;
var _c;
...
//# sourceMappingURL=src_de9ae329._.js.map
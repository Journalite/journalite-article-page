...
const CommentSection = ({ slug })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CommentSection.useEffect": ()=>{
            ...
            if (!slug) return;
            setLoading(true);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getArticleComments"])(slug).then({
    ...
    const handleCommentSubmit = async (e)=>{
        ...
        try {
            setSubmitting(true);
            const comment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postComment"])(slug, currentUser.id, newComment);
            setComments((prev)=>[
                    comment,
                    ...prev
                ]);
    ...
    const handleReplySubmit = async (commentId)=>{
        ...
        try {
            ...
            const reply = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postReply"])(slug, commentId, currentUser.id, replyContent);
    ...
    const handleLikeComment = async (commentId)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["likeComment"])(slug, commentId, currentUser.id);
            // Update local state
            setComments((prev)=>prev.map((comment)=>comment.commentId === commentId ? {
                        ...comment,
                        likes: result.likes
    ...
    const handleLikeReply = async (commentId, replyId)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["likeReply"])(slug, commentId, replyId, currentUser.id);
            // Update local state
            setComments((prev)=>prev.map((comment)=>comment.commentId === commentId ? {
                        ...comment,
    ...
    const handleDeleteComment = async (commentId)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteComment"])(slug, commentId, currentUser.id);
    ...
    const handleDeleteReply = async (commentId, replyId)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteReply"])(slug, commentId, replyId, currentUser.id);
                        ...
                        children: [
                            ...
                            comment.replies && comment.replies.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                children: [
                                    ...
                                    expandedReplies[comment.commentId] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            reply.userId === currentUser.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            replyingTo === comment.commentId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CommentSection, "IMx6qPcSsWrc/JIxeUCRFzM0t6A=");
_c = CommentSection;
...
function ArticlePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ArticlePage.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$c92d61ad$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$clientApp$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], {
                "ArticlePage.useEffect.unsubscribe": (user)=>{
                    setIsAuthenticated(!!user);
                }
            }["ArticlePage.useEffect.unsubscribe"]);
            // Fetch article data
            const fetchArticle = {
                "ArticlePage.useEffect.fetchArticle": async ()=>{
                    try {
                        setIsLoading(true);
                        if (!slug) return;
                        const articleData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$articleService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getArticle"])(slug);
            ...
            }["ArticlePage.useEffect.fetchArticle"];
            fetchArticle();
...
_s(ArticlePage, "gUzEeDRnRVJupYR72vTDjuVMGLo=", false, function() {
    return [
...
//# sourceMappingURL=src_3c6c868f._.js.map
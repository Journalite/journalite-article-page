 ...
 */ const Editor = /*#__PURE__*/ _s(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].forwardRef(_c = _s(({ articleId, initialContent = '', onChange, placeholder = 'Tell your story...', className = '' }, ref)=>{
    ...
    const insertHTMLAtCursor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Editor.useCallback[insertHTMLAtCursor]": (html)=>{
            if (!viewRef.current) return;
            try {
                const { state, dispatch } = viewRef.current;
                // Parse the HTML into a ProseMirror document fragment
                const fragment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$editor$2f$schema$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseHTML"])(html);
    ...
    }["Editor.useCallback[insertHTMLAtCursor]"], [
        insertTextAtCursor
    ]);
    // Method to insert image as proper ProseMirror node
    const insertImageAtCursor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Editor.useCallback[insertImageAtCursor]": (src, alt = '')=>{
            if (!viewRef.current) return;
    ...
    }["Editor.useCallback[insertImageAtCursor]"], []);
                ...
                const view = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorView"](editorRef.current, {
                    ...
                    handlePaste: {
                        "Editor.useEffect": (view, event)=>{
                            // Let MediaUploadPlugin handle all image-related pastes
                            // This handler only logs for debugging other paste events
                            const clipboardData = event.clipboardData;
                            if (!clipboardData) return false;
                            const htmlContent = clipboardData.getData('text/html');
                            const textContent = clipboardData.getData('text/plain');
                            // Only log non-image pastes for debugging
                            if (!htmlContent.includes('<img') && !textContent.includes('<img')) {
                                console.log('Editor: Non-image paste detected:', {
                                    htmlContent: htmlContent.substring(0, 100),
                                    textContent: textContent.substring(0, 100)
                                });
                            }
                            return false; // Let default paste handle non-image content
                        }
                    }["Editor.useEffect"]
                });
    ...
    const insertImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Editor.useCallback[insertImage]": ()=>{
            ...
            input.accept = 'image/*';
            input.onchange = ({
                "Editor.useCallback[insertImage]": async (e)=>{
                    ...
                    try {
                        ...
                        const { uploadImageViaAPI } = await __turbopack_context__.r("[project]/src/lib/cloudinary.ts [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
...
}, "Nb92qJ+UaQzm2pGjeuyqu36inFc=")), "Nb92qJ+UaQzm2pGjeuyqu36inFc=");
_c1 = Editor;
...
"[project]/src/components/MediaUploadPlugin.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function MediaUploadPlugin({ onImageInsert, onVideoInsert, editorRef, className = '' }) {
    ...
    const handleFileUpload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediaUploadPlugin.useCallback[handleFileUpload]": async (file)=>{
            if (!file) return;
            // Validate file type
            ...
            try {
                ...
                const progressInterval = setInterval({
                    "MediaUploadPlugin.useCallback[handleFileUpload].progressInterval": ()=>{
                        setUploadProgress({
                            "MediaUploadPlugin.useCallback[handleFileUpload].progressInterval": (prev)=>Math.min(prev + 10, 90)
                        }["MediaUploadPlugin.useCallback[handleFileUpload].progressInterval"]);
                    }
                }["MediaUploadPlugin.useCallback[handleFileUpload].progressInterval"], 200);
                const imageUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadImageViaAPI"])(file);
                ...
                setTimeout({
                    "MediaUploadPlugin.useCallback[handleFileUpload]": ()=>{
                        setUploadProgress(0);
                        setIsUploading(false);
                    }
                }["MediaUploadPlugin.useCallback[handleFileUpload]"], 500);
            } catch (error) {
                console.error('Upload failed:', error);
                alert('Upload failed. Please try again.');
                setIsUploading(false);
    ...
    const handlePaste = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediaUploadPlugin.useCallback[handlePaste]": (e)=>{
            const items = e.clipboardData?.items;
            const htmlContent = e.clipboardData?.getData('text/html');
            const textContent = e.clipboardData?.getData('text/plain');
            console.log('MediaUploadPlugin paste detected:', {
                items: items ? Array.from(items).map({
                    "MediaUploadPlugin.useCallback[handlePaste]": (i)=>i.type
                }["MediaUploadPlugin.useCallback[handlePaste]"]) : [],
                htmlContent,
                textContent
            });
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "MediaUploadPlugin.useEffect": ()=>{
            document.addEventListener('paste', handlePaste, true) // Use capture phase
            ;
            return ({
                "MediaUploadPlugin.useEffect": ()=>document.removeEventListener('paste', handlePaste, true)
            })["MediaUploadPlugin.useEffect"];
        }
    }["MediaUploadPlugin.useEffect"], [
        handlePaste
...
_s(MediaUploadPlugin, "FqFH0L4tLnRbec0xX1Fv2E2HSWA=");
_c = MediaUploadPlugin;
var _c;
__turbopack_context__.k.register(_c, "MediaUploadPlugin");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/components/MediumStyleEditor.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MediaUploadPlugin$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/MediaUploadPlugin.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
;
;
const MediumStyleEditor = /*#__PURE__*/ _s((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c = _s(({ articleId, initialContent = '', onChange, placeholder = 'Tell your story...', className = '', onImageInsert, onVideoInsert }, ref)=>{
    _s();
    const editorRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // Insert image at cursor position
    const insertImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediumStyleEditor.useCallback[insertImage]": (imageUrl, alt = '')=>{
    ...
    }["MediumStyleEditor.useCallback[insertImage]"], [
        onImageInsert
    ]);
    // Insert video at cursor position 
    const insertVideo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediumStyleEditor.useCallback[insertVideo]": (videoUrl)=>{
            if (!editorRef.current) return;
            // Call parent handler if provided
            if (onVideoInsert) {
    ...
    }["MediumStyleEditor.useCallback[insertVideo]"], [
        onVideoInsert
    ]);
    // Insert text at cursor position
    const insertText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediumStyleEditor.useCallback[insertText]": (text)=>{
            if (!editorRef.current) return;
            editorRef.current.insertText(text);
        }
    }["MediumStyleEditor.useCallback[insertText]"], []);
    // Focus the editor
    const focus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MediumStyleEditor.useCallback[focus]": ()=>{
            if (!editorRef.current) return;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useImperativeHandle"])(ref, {
        "MediumStyleEditor.useImperativeHandle": ()=>({
                insertText,
                insertImage,
                insertVideo,
                focus
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MediaUploadPlugin$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
}, "8U1tGyDFx5I0n5ysCXH3VOU7NjU=")), "8U1tGyDFx5I0n5ysCXH3VOU7NjU=");
_c1 = MediumStyleEditor;
MediumStyleEditor.displayName = 'MediumStyleEditor';
const __TURBOPACK__default__export__ = MediumStyleEditor;
var _c, _c1;
__turbopack_context__.k.register(_c, "MediumStyleEditor$forwardRef");
__turbopack_context__.k.register(_c1, "MediumStyleEditor");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function ImageUpload({ onImageUpload, disabled = false, className = '', acceptedFormats = [
    ...
    const handleFileSelect = async (event)=>{
        ...
        try {
            ...
            const imageUrl = useServerUpload ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadImageViaAPI"])(file) : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadImage"])(file);
            clearInterval(progressInterval);
            setUploadProgress(100);
...
_s(ImageUpload, "nysKlA8B/JyLOM7PWFq+MmwedZc=");
_c = ImageUpload;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$clientApp$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/clientApp.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MediumStyleEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/MediumStyleEditor.tsx [app-client] (ecmascript)");
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$MediumStyleEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            ref: editorRef,
...
//# sourceMappingURL=src_72db0bf7._.js.map
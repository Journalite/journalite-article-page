...
"[project]/src/utils/backgroundTheme.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getCurrentBackgroundTheme = ()=>{
    ...
    return localStorage.getItem('userBackgroundTheme') || 'default';
};
...
const applyBackgroundTheme = (themeId)=>{
    ...
    const selectedColor = getBackgroundColorById(themeId);
    if (selectedColor) {
        document.body.style.background = selectedColor.gradient;
        document.body.style.backgroundAttachment = 'fixed';
        localStorage.setItem('userBackgroundTheme', themeId);
    }
};
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$backgroundTheme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/backgroundTheme.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function MyThoughtsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyThoughtsPage.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$backgroundTheme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadSavedBackgroundTheme"])();
        }
    }["MyThoughtsPage.useEffect"], []);
...
_s(MyThoughtsPage, "SCxBwPU1O/LZc7rpK5/hl0r4hQg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_190db2a4._.js.map